    ...
    fetch("/admin/get_governor_details/" + nationalId)
        ...
        .then(data => {
            if (data.success) {
                ...
                document.getElementById("county").value = data.candidate.county;
                ...
                var formAction = "/admin/update/governor/" + nationalId;
                document.getElementById("updateForm").setAttribute("action", formAction);
            } else {
                alert("No governor found with the provided national ID.");
            }
        })
